...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#070A0F] border-t border-white/10 text-slate-400 text-sm">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              {hero?.logo?.url ? (
                ...
                <div className="flex items-center space-x-2">
                  <div className="bg-gradient-to-r from-red-600 to-[#FF2E4D] text-white font-black text-xl tracking-tighter px-2.5 py-0.5 rounded shadow-[0_0_12px_rgba(255,46,77,0.4)]">
                    SSD
                  </div>
            ...
            <p className="text-slate-400 text-xs sm:text-sm leading-relaxed max-w-sm">
              Premium cricket gear built for performance and international match standards.
            </p>
          </div>

          {/* Column 2: Quick Links */}
          <div className="space-y-4">
            <h3 className="font-heading font-black text-white uppercase tracking-wider text-xs">
              Quick Links
            </h3>
            <ul className="space-y-2.5 text-xs sm:text-sm">
              <li>
                <Link to="/" className="text-slate-400 hover:text-[#FF2E4D] transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/catalog" className="text-slate-400 hover:text-[#FF2E4D] transition-colors">
                  Catalog
                </Link>
              </li>
              <li>
                <Link to="/#about" className="text-slate-400 hover:text-[#FF2E4D] transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <a href="#contact" className="text-slate-400 hover:text-[#FF2E4D] transition-colors">
                  Contact Us
                </a>
              </li>
              <li>
                <Link to="/track-order" className="text-slate-400 hover:text-[#FF2E4D] transition-colors">
                  Track Order
                </Link>
              </li>
            </ul>
                ...
                {hasEmail && (
                  <li className="flex items-center space-x-3 text-slate-400">
                    ...
                    <a
                      ...
                      className="hover:text-[#FF2E4D] transition-colors break-all"
                    >
              ...
              <div className="flex items-center space-x-3">
                {hasInstagram && (
                  <a
                    ...
                    className="w-10 h-10 rounded-full border border-white/10 bg-slate-900/80 flex items-center justify-center text-slate-300 hover:text-white hover:border-[#FF2E4D] hover:bg-[#FF2E4D] transition-all duration-300"
                  >
